...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'maghettoni.com', 'www.maghettoni.com']
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'maghettoni.pipeline.prevent_duplicate_social_auth',  # ✅ Here
    'social_core.pipeline.social_auth.auth_allowed',
    'social_core.pipeline.social_auth.social_user',
    'social_core.pipeline.user.get_username',
    'social_core.pipeline.user.create_user',
    'maghettoni.pipeline.save_user_details',  # where you set is_parent, etc.
...
CORS_ALLOW_HEADERS = [
    ...
    'x-csrftoken',
    'x-requested-with',
    'x-session-key',  # Flutter session auth
]
...
LOGGING = {
    ...
    'loggers': {
        'maghettoni.session_header_middleware': {
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': False,
        },
